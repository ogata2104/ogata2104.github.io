...
<div style="display: flex; flex-wrap: wrap; gap: 12px;">
  ...
  <div style="flex: 1; min-width: 160px; max-width: 200px; border: 1px solid #e1e4e8; border-radius: 12px; padding: 12px; background-color: #f6f8fa;">
    <a href="https://open.spotify.com/track/3tLJ606Lf0qJEB14vXFJ2a" style="text-decoration: none;">
      ...
      <div style="font-size: 13px; font-weight: bold; color: #0366d6; line-height: 1.3; margin-bottom: 4px;">Next To You (Someday I'll Be)</div>
      <div style="font-size: 11px; color: #586069;">Wilson Phillips</div>
    </a>
  </div>
  <div style="flex: 1; min-width: 160px; max-width: 200px; border: 1px solid #e1e4e8; border-radius: 12px; padding: 12px; background-color: #f6f8fa;">
    <a href="https://open.spotify.com/track/7cdnq45E9aP2XDStHg5vd7" style="text-decoration: none;">
      <img src="https://i.scdn.co/image/ab67616d0000b273a1c553575418ca43404cb48b" style="width: 100%; border-radius: 8px; aspect-ratio: 1/1; object-fit: cover; margin-bottom: 8px;">
      <div style="font-size: 13px; font-weight: bold; color: #0366d6; line-height: 1.3; margin-bottom: 4px;">Cherry Bomb</div>
      <div style="font-size: 11px; color: #586069;">The Runaways</div>
    </a>
  </div>
  <div style="flex: 1; min-width: 160px; max-width: 200px; border: 1px solid #e1e4e8; border-radius: 12px; padding: 12px; background-color: #f6f8fa;">
...
<div style="display: flex; gap: 10px; align-items: center;">
  ...
  <a href="https://www.instagram.com/ogata2104" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/-&logo=Instagram&logoColor=%23E4405F" alt="Instagram" height="32">
  </a>

  <a href="https://www.facebook.com/ogata2104" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/-&logo=Facebook&logoColor=%231877F2" alt="Facebook" height="32">
  </a>

  <a href="https://www.linkedin.com/in/ogata2104/" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/-&logo=LinkedIn&logoColor=%230077B5" alt="LinkedIn" height="32">
  </a>
